...
This project creates an LSTM model and downloads it to your local computer with one button click. It also generates text using the LSTM model and outputs this text in the console. This project is based off of this [tensorflowjs example](https://github.com/tensorflow/tfjs-examples/tree/master/lstm-text-generation).
