...
export class SaveableLSTMTextGenerator extends LSTMTextGenerator {
  ...
  constructor(textData) {
    ...
    this.MODEL_SAVE_PATH_PREFIX_ = 'downloads://lstm-text-generation-model';//'indexeddb://lstm-text-generation';
    this.modelSavePath_ =
      `${this.MODEL_SAVE_PATH_PREFIX_}/${this.modelIdentifier_}`;
    console.log('CHECK IT OUT YOOOO! MODEL SAVED: ' + this.modelSavePath_);
  }
